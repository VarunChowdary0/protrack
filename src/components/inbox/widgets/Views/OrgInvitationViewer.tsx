...
const OrgInvitationViewer: React.FC<Props> = ({ invitation,handleStarToggle,handleTrashItem,handleArchiveItem,handleItemChange }) => {
...
export default OrgInvitationViewer